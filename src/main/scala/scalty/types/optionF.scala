...
final class OptionFExtension[T](val value: T) extends AnyVal{
  @inline final def toOptionF: OptionF[T] = OptionT.pure[Future](value)(or.currentThreadExecutionFutureInstances)
}

final class OptionTExtension[T](val value: Option[T]) extends AnyVal {
  @inline final def toOptionF: OptionF[T] = OptionT.fromOption[Future](value)(or.currentThreadExecutionFutureInstances)
}
